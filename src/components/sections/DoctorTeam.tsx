...
export default function DoctorTeam() {
  return (
    <section className="bg-cream py-20 sm:py-24 md:py-28">
          ...
          {doctors.map((doctor, index) => (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-sage/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
